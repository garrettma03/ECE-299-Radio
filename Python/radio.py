    ...
    #
        ...
        print("prevButton :", prevButton)
        print("curButton :", curButton)
        print("Machine.Pin value: ", button0.value())
        ...
        print( "5 - push button to increase volume" )
    ...
    #
            ...
            while (True):
                try:
                    curButton = button0.value()
                    if curButton == 1 and prevButton == 0:  # Button was just pressed
                        print("Button Pushed")
                        newVolume = (newVolume + 1) % 16
                        print(newVolume)
                        if ( fm_radio.SetVolume( newVolume ) == True ):
                            fm_radio.ProgramRadio()
               
                    prevButton = curButton
                
                except KeyboardInterrupt:
                    input("You pressed CTRL+C")
